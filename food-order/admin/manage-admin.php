    ...
    <a href='add-admin.php' class="btn-primary">Add Admin</a>
        ...
        <tr>
           ...
           <?php 
              ...
              if($res == True)
              {
                //count rows to check wheathger we have data in databse or not
                $count = mysqli_num_rows($res); //fumction to get all values

                $sn = 1; //create a variable and assing value
                ...
                if($count>0)
                {
                    ...
                    {
                        // using while loop to get all the data from the databse
